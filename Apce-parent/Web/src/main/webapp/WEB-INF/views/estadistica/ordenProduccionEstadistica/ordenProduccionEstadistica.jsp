...
<body>
	...
	<div>
		<form:form id="form" method="get"
			action="/web/EstadisticaOrdenProduccion/filtro"
			modelAttribute="ordenProduccionEstadisticaForm" cssClass="cleanform">
			<table>
				<tr>
				...
				<tr>
					...
					<td><kendo:comboBox name="anio" placeholder="Seleccione Año"
							value="${ordenProduccionEstadisticaForm.anio}">
				...
				<tr>
					<td><kendo:chart name="chart">
							<kendo:chart-series>
								<kendo:chart-seriesItem type="column" data="${cantidadesAnio}"
									color="green" aggregate="sum" />
							</kendo:chart-series>
							<kendo:chart-categoryAxis>
								<kendo:chart-categoryAxisItem type="date"
									categories="${fechasAnio}" baseUnit="months">
				...
				<tr>
					...
					<td><kendo:comboBox name="mes" placeholder="Seleccione Mes"
							value="${ordenProduccionEstadisticaForm.mes}">
