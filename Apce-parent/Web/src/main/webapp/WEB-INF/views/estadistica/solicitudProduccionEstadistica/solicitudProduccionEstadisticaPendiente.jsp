...
<body>
	...
	<div>
		<c:url
			value="/EstadisticaSolicitudProduccionPendiente/SolicitudProduccionList/filtrarSolicitudProduccion"
				...
				<kendo:dataSource-schema data="data" total="total" groups="data">
					<kendo:dataSource-schema-model>
						<kendo:dataSource-schema-model-fields>
							...
							<kendo:dataSource-schema-model-field name="formato1"
								type="string" />
							<kendo:dataSource-schema-model-field name="formato2"
								type="string" />
							<kendo:dataSource-schema-model-field name="fondo" type="string" />
							<kendo:dataSource-schema-model-field name="film" type="string" />
							<kendo:dataSource-schema-model-field name="impreso"
								type="integer" />
						</kendo:dataSource-schema-model-fields>
					</kendo:dataSource-schema-model>
	...
	<div>
		<kendo:chart name="chartAdhesivo">
			...
			<kendo:chart-series>
				<kendo:chart-seriesItem type="pie" data="${solicitudProduccionList}"
