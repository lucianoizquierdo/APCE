...
@Controller
@RequestMapping("/EstadisticaSolicitudProduccion")
@SessionAttributes({"solicitudProduccionEstadisticaForm"} ) 
public class SolicitudProduccionEstadisticaController {
	...
	@RequestMapping(value = "/", method = RequestMethod.GET)
	    public String getGraficoBarras(Model model) throws ParseException {
	        ...
	        Map<Date,Integer> fechas_count = solicitudProduccionService.getGraficoBarrasSolicitudesProduccion();
	        ...
	        return "solicitudProduccionEstadistica";
	    }
...
//		List<Integer> resultCantidad = new ArrayList<Integer>();
	...
	private Object[] getGraficoBarrasMes(String mes,Integer anio) throws ParseException {
		...
		List<Integer> resultCantidad = new ArrayList<Integer>();
	 	...
	 	Map<Date,Integer> fechas_count = solicitudProduccionService.getGraficoBarrasSolicitudesProduccion(fechaInicio, fechaFin);
